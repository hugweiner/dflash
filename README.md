...
> **Note (personal):** I've found that reducing `num_speculative_tokens` to `10` gives a better latency/quality tradeoff on smaller GPUs (e.g. A10G). Worth experimenting with values between 8–15 depending on your hardware.
